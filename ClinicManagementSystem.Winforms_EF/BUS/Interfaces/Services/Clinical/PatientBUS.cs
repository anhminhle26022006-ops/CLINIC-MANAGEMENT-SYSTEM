...
namespace BUS.Services
{
    public class PatientBUS
    {
        ...
        public List<PatientDTO> GetList() => dal.GetAll();
        ...
        public bool UpdatePatient(PatientDTO patient)
        {
            ...
            return dal.Update(patient);
        }

        public int CountPatients() => dal.CountPatients();

        public string GenerateNewPatientCode() => dal.GenerateNewPatientCode();
    }
}