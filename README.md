...
- DAL (Data Access Layer): Handles SQL queries & database operations
- BUS (Business Logic Layer): Processes business rules
- UI (WinForms Forms): User interface for all roles
