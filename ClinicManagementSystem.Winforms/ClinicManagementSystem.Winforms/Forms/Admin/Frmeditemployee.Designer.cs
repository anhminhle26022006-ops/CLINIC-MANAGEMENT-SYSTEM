...
namespace ClinicManagementSystem.Winforms.Forms.Admin
{
    partial class frmEditEmployee
    {
        ...
        private void InitializeComponent()
        {
            ...
            AddTxt(panelBody, txtFullName, c1, 40, w, h);
            ...
            cboChucVu.SelectedIndex = 0; panelBody.Controls.Add(cboChucVu);
            ...
            AddTxt(panelBody, txtPhone, c2, 120, w, h);

            AddLbl(panelBody, lblEmail, "Email *", c1, 176);
            AddTxt(panelBody, txtEmail, c1, 200, w, h);
            ...
            cboGender.Items.AddRange(new object[] { "Nam", "Nữ" }); cboGender.SelectedIndex = 0;
            panelBody.Controls.Add(cboGender);

            AddLbl(panelBody, lblStatus, "Trạng thái", c1, 256);
            cboStatus.Location = new System.Drawing.Point(c1, 280); cboStatus.Size = new System.Drawing.Size(w * 2 + 56, h);
            cboStatus.DropDownStyle = ComboBoxStyle.DropDownList; cboStatus.Font = new Font("Segoe UI", 10F);
            cboStatus.Items.AddRange(new object[] { "Đang làm việc", "Nghỉ việc" }); cboStatus.SelectedIndex = 0;
            ...
            panelFooter.Controls.Add(btnCancel); panelFooter.Controls.Add(btnSave);
        ...
        private void AddLbl(Panel p, Label lbl, string text, int x, int y)
        {
            ...
            lbl.ForeColor = Color.FromArgb(55, 65, 81); p.Controls.Add(lbl);
        }
        private void AddTxt(Panel p, TextBox tb, int x, int y, int w, int h)
        {
        ...
        private Label lblTitle, lblFullName, lblChucVu, lblKhoa, lblPhone, lblEmail, lblGender, lblStatus;
        private TextBox txtFullName, txtPhone, txtEmail;
        private ComboBox cboChucVu, cboKhoa, cboGender, cboStatus;
